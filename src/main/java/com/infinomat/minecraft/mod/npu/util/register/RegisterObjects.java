...
import static com.infinomat.minecraft.mod.npu.blocks.NpuBlocks.BLOCKS;
import static com.infinomat.minecraft.mod.npu.creativemodtab.NpuCreativeModeTabs.CREATIVE_MODE_TABS;
import static com.infinomat.minecraft.mod.npu.entities.NpuEntities.ENTITY_TYPES;
import static com.infinomat.minecraft.mod.npu.items.NpuItems.ITEMS;
