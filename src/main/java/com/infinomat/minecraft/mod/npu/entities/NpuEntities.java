...
import com.infinomat.minecraft.mod.npu.entities.npuentitynewclasses.GoldenChicken.GoldenChicken;
import com.infinomat.minecraft.mod.npu.entities.npuentitynewclasses.GoldenChicken.GoldenChickenRenderer;
import com.infinomat.minecraft.mod.npu.entities.npuentitynewclasses.vehicle.Bike.Bike1.Bike1;
import com.infinomat.minecraft.mod.npu.entities.npuentitynewclasses.vehicle.Bike.Bike1.Bike1Renderer;
import com.infinomat.minecraft.mod.npu.entities.npuentitynewclasses.vehicle.Bike.Bike2.Bike2;
import com.infinomat.minecraft.mod.npu.entities.npuentitynewclasses.vehicle.Bike.Bike2.Bike2Renderer;
import com.infinomat.minecraft.mod.npu.entities.npuentitynewclasses.vehicle.Bike.Bike3.Bike3;
import com.infinomat.minecraft.mod.npu.entities.npuentitynewclasses.vehicle.Bike.Bike3.Bike3Renderer;
import com.infinomat.minecraft.mod.npu.entities.npuentitynewclasses.vehicle.NpuVehicle;
import com.infinomat.minecraft.mod.npu.entities.npuentitynewclasses.vehicle.SchoolBus.SchoolBus;
import com.infinomat.minecraft.mod.npu.entities.npuentitynewclasses.vehicle.SchoolBus.SchoolBusRenderer;
